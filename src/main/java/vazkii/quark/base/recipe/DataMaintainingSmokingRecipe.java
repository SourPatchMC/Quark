...
public class DataMaintainingSmokingRecipe extends SmokingRecipe {
	...
	public DataMaintainingSmokingRecipe(AbstractCookingRecipe parent, Ingredient pullDataFrom) {
	...
	public static class Serializer implements RecipeSerializer<DataMaintainingSmokingRecipe> {
		...
		@NotNull
		@Override
		public DataMaintainingSmokingRecipe fromJson(@NotNull ResourceLocation recipeId, @NotNull JsonObject json) {
			...
			return new DataMaintainingSmokingRecipe(cookingRecipe, pullFrom);
		}

		@NotNull
		@Override
		public DataMaintainingSmokingRecipe fromNetwork(@NotNull ResourceLocation recipeId, @NotNull FriendlyByteBuf buffer) {
		...
		public void toNetwork(@NotNull FriendlyByteBuf buffer, @NotNull DataMaintainingSmokingRecipe recipe) {
